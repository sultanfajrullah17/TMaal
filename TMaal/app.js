...
function initDashboard() {
    ...
    // Header Info
    const orgName = user.userType === "umkm" ? user.businessName : `${user.userType.toUpperCase()} ${user.fullName}`;
    ...
    document.getElementById("header-user-name").innerText = user.fullName;
    document.getElementById("header-user-role").innerText = user.userType === 'umkm' ? 'UMKM' : user.userType;
...
function updateFinancialSummary() {
    ...
    document.getElementById("dashboard-balance-update").innerText = `Terakhir diupdate pukul ${timeStr} WIB`;
}
...
function renderRecentTransactions() {
    ...
    sorted.forEach(t => {
        ...
        const icon = isIncome ? '<i class="fa-solid fa-circle-arrow-down"></i>' : '<i class="fa-solid fa-circle-arrow-up"></i>';
